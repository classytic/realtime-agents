...
export const OPENAI_REALTIME_MODELS: readonly OpenAIRealtimeModel[] = [
  {
    id: "gpt-realtime",
    name: "GPT Realtime",
    description: "Latest stable (auto-routes)",
  },
  {
  ...
  },
  {
    ...
    description: "Smaller, faster, lower cost",
  },
  {
    id: "gpt-realtime-mini-2025-10-06",
    name: "GPT Realtime Mini (2025-10-06)",
    description: "Pinned mini release",
  },
  {
    id: "gpt-4o-realtime-preview",
    name: "GPT-4o Realtime",
    description: "GPT-4o class realtime",
  },
  {
    id: "gpt-4o-mini-realtime-preview",
    name: "GPT-4o Mini Realtime",
    description: "GPT-4o mini class realtime",
  },
  {
    id: "gpt-realtime-1.5",
...
export const OPENAI_TRANSPORTS: readonly {
  id: OpenAITransport;
  name: string;
  description: string;
}[] = [
  {
    id: "webrtc",
    name: "WebRTC",
    description: "Browser audio/video with automatic mic/speaker handling",
  },
  {
    id: "websocket",
    name: "WebSocket",
    description:
      "Raw WebSocket — audio must be handled separately (Node.js compatible)",
  },
] as const;
